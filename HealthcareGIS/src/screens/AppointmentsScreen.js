...
export default function AppointmentsScreen() {
  ...
  const renderItem = useCallback(({ item, index }) => (
    <AppointmentCard appointment={item} enterDelay={index * 100} />
  ), []);
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Animated.View entering={FadeIn.delay(300).duration(500)} style={styles.emptyWrap}>
            ...
            <Text style={[FONTS.caption, { color: colors.textSecondary, fontSize: 14, textAlign: 'center', lineHeight: 20 }]}>
...
const styles = StyleSheet.create({
  ...
  emptyCircle: { width: 80, height: 80, borderRadius: 40, alignItems: 'center', justifyContent: 'center', marginBottom: SPACING.lg },
});
